...
varexo
E_EPS_C  E_EPS_ETA  E_EPS_ETAM E_EPS_ETAX  E_EPS_EX  E_EPS_IG E_EPS_INOMW E_EPS_L E_EPS_LOL E_EPS_M
...
UCAP0      =   1;
L0         =  0.65;
GTFP0      =  0.0024230769230769223;// (ALPHAE+ALPHAGE-1)/ALPHAE*GY0-(2-ALPHAE-ALPHAGE)/ALPHAE*GPCPI0;
E_EX_R     =  0.004016064257028162; // 1/BETAE-1;    %   -log(BETAE);
E_EX_INOMW =  0.009016064257028163; // E_EX_R+GP0;
E_EX_RW = 0.004016064257028163; //E_EX_INOMW - GPW0;
LYWY0 = 0;
